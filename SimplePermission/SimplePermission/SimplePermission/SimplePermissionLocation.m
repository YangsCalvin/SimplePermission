...
#import "SimplePermissionLocation.h"
#import <UIKit/UIKit.h>

@interface SimplePermissionLocation()<CLLocationManagerDelegate>
@property(nonatomic,strong) CLLocationManager *locationManager;
@property (nonatomic, copy) void (^permissionCompletion)(BOOL granted,BOOL firstTime);
@end

@implementation SimplePermissionLocation

+ (instancetype)sharedManager
{
    static SimplePermissionLocation* _sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedInstance = [[SimplePermissionLocation alloc] init];
    });
...
+ (void)authorizeWithCompletion:(void(^)(BOOL granted,BOOL firstTime))completion;
{
    ...
    switch (authorizationStatus) {
        ...
        case kCLAuthorizationStatusNotDetermined:
        {
            ...
            [[SimplePermissionLocation sharedManager]startGps:completion];
        }
            break;
