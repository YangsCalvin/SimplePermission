//
//  SimplePermissionNet.m
//
//
//  Created by Easyia on 2018/7/31.
//  Copyright © 2018年 Easy. All rights reserved.
//

#import "SimplePermissionNet.h"
#import "NetReachability.h"
#import "SimplePermissionData.h"

@interface SimplePermissionNet()
...
@implementation SimplePermissionNet

+ (instancetype)sharedManager
{
    static SimplePermissionNet* _sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedInstance = [[SimplePermissionNet alloc] init];
...
- (void)listenNetPermisson
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        [SimplePermissionData authorizeWithCompletion:^(BOOL granted, BOOL firstTime)
         {
